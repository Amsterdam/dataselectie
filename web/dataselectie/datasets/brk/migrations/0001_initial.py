# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-03-14 10:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Eigendommen',
            fields=[
                ('id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='brk.ZakelijkRecht')),
                ('aard_zakelijk_recht_akr', models.CharField(max_length=3, null=True)),
                ('grondeigenaar', models.BooleanField()),
                ('aanschrijfbaar', models.BooleanField()),
                ('appartementseigenaar', models.BooleanField()),
            ],
            options={
                'managed': False,
            },
