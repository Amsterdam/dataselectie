# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-03-20 11:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='EigendomBuurt',
            fields=[
                ('kadastraal_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='buurten', serialize=False, to='brk.KadastraalObject')),
                ('buurt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='eigendommen', to='bag.Buurt')),
            ],
            options={
                'managed': False,
            },
        ...
        migrations.CreateModel(
            name='EigendomGGW',
            fields=[
                ('kadastraal_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='ggws', serialize=False, to='brk.KadastraalObject')),
                ('ggw', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='eigendommen', to='bag.Gebiedsgerichtwerken')),
            ],
            options={
                'managed': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('kadastraal_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='stadsdelen', serialize=False, to='brk.KadastraalObject')),
                ('stadsdeel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='eigendommen', to='bag.Stadsdeel')),
            ],
            options={
                'managed': False,
            },
        ...
        migrations.CreateModel(
            name='EigendomWijk',
            fields=[
                ('kadastraal_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='wijken', serialize=False, to='brk.KadastraalObject')),
                ('buurt_combi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='eigendommen', to='bag.Buurtcombinatie')),
            ],
            options={
                'managed': False,
            },
